...
public class SpringApplication {
	...
	/**
	 * spring.factories 文件中指定的 ApplicationContextInitializer 实现类实例列表
	 */
	private List<ApplicationContextInitializer<?>> initializers;

	/**
	 * spring.factories 文件中指定的 ApplicationListener 实现类实例列表
	 */
	...
	/**
	 * 获取 spring.factories 文件中给定类型的实例
	 *
	 * @param type
	 * @param <T>
	 * @return
	...
	/**
	 * 创建 spring.factories 文件中给定类型的实例
	 *
	 * @param type
	 * @param parameterTypes
	 * @param classLoader
