...
public final class ConfigurationPropertyName implements Comparable<ConfigurationPropertyName> {
	 ...
	 *
	 * @param name                the source name
	 * @param returnNullIfInvalid 给定名称无效时是否返回 null
	 *                            if null should be returned if the name is not valid
	 * @return a {@link ConfigurationPropertyName} instance
	...
	/**
	 * 使用给定的字符串创建 Elements 实例
	 *
	 * @param name
	 * @param returnNullIfInvalid
	 * @return
	 */
	...
	/**
	 * 字符串转 ConfigurationPropertyName
	 * <p>
